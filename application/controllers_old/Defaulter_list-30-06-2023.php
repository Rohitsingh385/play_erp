	  ...
	  <?php
	   ...
	   <tfoot>
            <tr>
                ...
                <td></td>
				<td></td>
				<td><b style="font-size:16px;color:black;font-weight: 900;">GRAND TOTAL</b></td>
				
				
				<td><b style="font-size:16px;color:black;font-weight: 900;"><?php echo $grand_tot;?></b></td>
            </tr>
        </tfoot>
	  </table></br>
	  <a href="<?php echo base_url('Defaulter_list/defaulter_classwise_PDF/'.$viewupto.'/'.$classs.'/'.$sec)?>";>
		<center>
		<button class='btn btn-success'><i class="fa fa-file-pdf-o"></i> Download classWise Defaulter List</button>
		</center>
		</a>
