...
class Mymodel extends CI_model{
	...
	public function tc_issue($id){
		$query = $this->db->query("SELECT student.ADM_DATE,student.SUBJECT1,student.SUBJECT2,student.SUBJECT3,student.SUBJECT4,student.SUBJECT5,student.SUBJECT6,student.FIRST_NM,student.MOTHER_NM,student.FATHER_NM,student.FIRST_NM,student.DISP_CLASS,student.NATION,student.BIRTH_DT,classes.CLASS_NM AS ADM_CLASSS,student.CBSE_REG,student.CBSE_ROLL,student.ADM_NO,category.CAT_ABBR FROM ((student LEFT JOIN category ON category.CAT_CODE=student.CATEGORY) LEFT JOIN classes ON student.ADM_CLASS=classes.Class_No) WHERE student.ADM_NO='$id'");
		return $query->row();
	}
