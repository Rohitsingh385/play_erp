...
<body>
	<div>
		<!-- <p style='float:right; font-size:12px;'>Report Generation Date:<?php //echo date('d-M-Y'); 
																			?></p><br /><br><br> -->
		<center>
			<h3 style='font-size:30px;'><?php echo $School_Name; ?></h3><br>
			<p style='font-size:22px; position:relative; top:-10px;'><?php echo $School_Address; ?>&nbsp;(<?php echo $School_Session; ?>)</p><br>
