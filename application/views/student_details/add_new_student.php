                ...
                <div class="tab-content">
                  ...
                  <div class="form-row">
                        ...
                        <div class="box box-primary" style="border-top: 3px solid #5785c3;">
                            <div class="box-header with-border">
                                <h3 class="box-title">Admission in mid session
                                    <button type="button" data-toggle="collapse" data-target="#leave" aria-expanded="true" class="btn-xs btn-black"><i class="fa fa-plus"></i></button>
                                </h3>
                                <hr>
                            </div>
                            <!-- /.box-header -->
                    ...
                    <div class="tab-pane" id="tab2">
                      ...
                      <div class="col-md-12">
                         <center><span id="std_error" class="span"></span></center>
                          <center><a href="#" id="btnbackpar" class="btn btn-success">BACK</a>&nbsp;
                      </div>
                  </div>                    -->
                    </div>
