...
<form method="post" action="<?php echo base_url('Student_details/re_update'); ?>" id="form" onsubmit="return validation()" enctype="multipart/form-data">
  <div style="padding: 10px; background-color: white">
    <div class="row">
      ...
      <div class="col-md-2">
        <center><input type="submit" name="submit" value="Update11" class="btn btn-success"></center><br>
      </div>
      <div class="col-sm-1">
          ...
          <div class="tab-pane fade active in cont" id="tab1">
                            ...
                            <label>House</label>
                             <select required name="house" id="house" class="form-control">
                               <?php
                                ...
                                // 
                                ?>
                                  // <option value="<?php //echo $house_code->HOUSENO; 
                                                    ?>" <?php //if($HOUSE_CODE==$house_code->HOUSENO) {echo "selected";} 
                                                        ?> ><?php //echo $house_code->HOUSENAME; 
                                                                                                ?></option>
                                  // <?php
                                      // }
                                      // }
            ...
            <!--<div class="form-row">
                      ...
                      <div class="form-group col-md-6">
                       ...
                       <select name="SCIENCE_FEE" required id="SCIENCE_FEE" class="form-control">
                         <option value="0" <?php //if($Science_subject==0){echo "selected";} 
                                            ?>>select subject</option>
                         <option value="1" <?php // if($Science_subject==1){echo "selected";} 
                                            ?> >1 subject</option>
                         <option value="2" <?php // if($Science_subject==2){echo "selected";} 
                                            ?> >2 subject</option>
                         <option value="3" <?php // if($Science_subject==3){echo "selected";} 
                                            ?> >3 subject</option>
                         <option value="4" <?php //if($Science_subject==4){echo "selected";} 
                                            ?> >4 subject</option>
                       </select>
                      </div>   
                    </div>-->
            <!--<div class="form-row">
                      <div class="form-group col-md-3">
                        <label>Hostel</label>
                        <input type="radio" name="radio1" value="1" <?php //if($HOSTEL_STATUS==1) {echo "checked";} 
                                                                    ?>>Yes
                        <input type="radio" name="radio1" value="0" <?php //if($HOSTEL_STATUS==0) {echo "checked";} 
                                                                    ?> >No
                      </div>
                      <div class="form-group col-md-3">
                        <label>Computer</label>
                        <input type="radio" name="radio2" value="1" <?php // if($COUMPUTER_STATUS==1) {echo "checked";} 
                                                                    ?>>Yes
                        <input type="radio" name="radio2" value="0" <?php // if($COUMPUTER_STATUS==0) {echo "checked";} 
                                                                    ?>>No
                      </div>
                      
                      <div class="form-group col-md-3 col-sm-3 col-lg-3">
                        <label>Handicap</label>
                        <input type="radio" name="radio4" value="1" <?php // if($HANDICAP==1) {echo "checked";} 
                                                                    ?> onclick="handicapp(this.value)" >Yes
                        <input type="radio" name="radio4" value="0" <?php //if($HANDICAP==0) {echo "checked";} 
                                                                    ?> onclick="handicapp(this.value)" >No<br>
                        <input type="text" id="handi_nature" name="handicap" class="form-control" value="<?php // echo $HANDICAP_NATURE; 
                                                                                                          ?>" <?php //if($HANDICAP==0) {echo "disabled";} 
                                                                                                              ?>>    
                      </div>             
                  </div>-->
            ...
            <div class="row">
              <div class="col-md-6 col-sm-6 col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" style="text-transform:uppercase;" id="crossmoblile" name="cross_mobile" class="form-control" value="<?php echo $CROSSMOBILE; ?>">
                </div>
                <div class="form-group">
              ...
              <div class="col-sm-6 col-md-6 col-lg-6">
                ...
                <div class="form-group">
                  <label>Mobile No.</label>
                  <input type="text" style="text-transform:uppercase;" name="per_mobile" id="permobile" class="form-control" value="<?php echo $PERMOBILE; ?>">
                </div>
                <div class="form-group">
                  <label>Phone No.</label>
