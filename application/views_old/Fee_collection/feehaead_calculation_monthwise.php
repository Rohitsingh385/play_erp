         ...
         <div class="row" style="display: none;" id="card_show">
			 ...
			 <div class="row" style="display: none;" id="transation_show">
         		<div class="col-md-12 form-group">
         			...
         			<input type="text" placeholder="Enter transation id" autocomplete="off" value="0" name="transation_name" id="transation_name" class="form-control">
         		</div>
         	</div>
	...
	function amtref()
	 	{
	 		...
	 		var sum =(feehead1+feehead3+feehead4+feehead5+feehead6+feehead8+feehead9);
	 		$("#totalamount").val(sum);
	 		$("#npa").val(sum);
	 	}
