...
<p style='float:right; font-size:14px;'>Report Generation Date:<?php echo date('d-M-Y'); ?></p><br />
	<center><h1 style='font-size:30px;'><?php echo $School_Name; ?></h1>
			...
			<p style='font-size:18px; position:relative; top:-25px;'>Session (<?php echo $School_Session; ?>)</p>
		<p style='font-size:16px; position:relative; top:-35px;'>Daily Collection Report as on <?php echo date('d-M-Y',strtotime($date_type)); ?></p>
		
	</center>
</div>


<hr style='position:relative; top:px;'>
<table border='1'>
	<thead>
		<tr>
			<th>Sl. No.</th>
...
<table>
	...
	<br/><br/><br/>
<caption style='font-size:18px!important;' ><h4>Amount Collection By Card/Cash/Cheque/Online</h4></caption><br>
