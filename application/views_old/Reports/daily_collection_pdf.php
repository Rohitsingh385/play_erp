...
<!-- <p style='float:right; font-size:12px;'>Report Generation Date:<?php //echo date('d-M-Y'); ?></p><br /><br><br> -->
	<center><h1 style='font-size:30px;'><?php echo $School_Name; ?></h1>
			<p style='font-size:22px; position:relative; top:-10px;'><?php echo $School_Address; ?>, Session&nbsp;(<?php echo $School_Session; ?>)</p><br>
			<p style='font-size:22px; position:relative; top:-25px;'><!--<Session&nbsp;(<?php //echo $School_Session; ?>)--></p>
			<p  style='font-size:22px;position:relative;;top:-40px;'>Daily Collection Report As On&nbsp; <?php  echo date('d-M-Y',strtotime($date_type));?></p>
	</center>
</div>
...
<table>
	...
	<br/><br/>
<caption style='font-size:18px!important;' ><h4>Amount Collection By Card/Cash/Cheque/Online</h4></caption>
