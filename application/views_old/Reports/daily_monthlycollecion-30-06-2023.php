						...
						if($('#date_wise').is(':checked'))
						{
							if(single!='')
							{
								...
								$.ajax({
									...
									type: "POST",
									data:{collectiontype:collectiontype,feecollectiontype:feecollectiontype,collectioncounter:collectioncounter,single:single},
						...
						if($('#month_wise').is(':checked'))
						{
							if(multiple_date1!='' && multiple_date2!='')
							{
								...
								$.ajax({
									...
									type: "POST",
									data:{collectiontype:collectiontype,feecollectiontype:feecollectiontype,collectioncounter:collectioncounter,multiple_date1:multiple_date1,multiple_date2:multiple_date2},
									success:function(data)
									{
										$('#load_page').html(data);
										$('#load_page').show(1000);
