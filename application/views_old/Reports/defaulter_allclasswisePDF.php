...
<body>
    ...
    <table width="100%" style="float:right;">
        <tr>
            <td id="tp-header" style="text-align:center">
                <?php echo $School_setting[0]->School_Name; ?>
            </td>
        </tr>
        <tr>
            <td id="mid-header" style="text-align:center">
                <?php echo $School_setting[0]->School_Address; ?>
            </td>
        </tr>
        <tr>
            <th style="text-align:center;background-color:;color: !important;">&nbsp;Defaulter  List  Of  AllClass&nbsp;&nbsp;Upto &nbsp;<?php echo $viewupto; ?></th>
    </tr>
