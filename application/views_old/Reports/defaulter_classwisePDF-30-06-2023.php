...
<body>
    ...
    <table width="100%" style="float:right;">
        ...
        <tr>
            <th style="text-align:center;background-color:;color: !important;">&nbsp;Defaulter List for Class&nbsp;<?php echo $classs; ?>&nbsp; for the month of <?php echo $viewupto; ?></th>
    </tr>
    </table><br /><br /><br /><br />
    <hr>
    <div class='row'>
                ...
                <table border="1" id='example' style="width: 100%;margin: 0px -30px 0px -20px;" cellpadding='0' cellspacing='0'>
                        ...
                        for ($i = 0; $i < $student_cnt; $i++) {
                           ...
                           // @$previous_duess = $student[$i]->previous_dues;
                            ...
                            if ($total_amount > 0) {
                                ...
                                ?>
                                <tr>
                                    <td align='center'><b style="font-size:12px;color:dark;"><?php echo $c; ?></td>
                                    <td align='left'><b style="font-size:12px;color:dark;"><?php echo $student[$i]->FIRST_NM; ?></td>
                                    <td><b style="font-size:12px;color:dark;"><?php echo $student[$i]->ADM_NO; ?></td>
                                    ...
                                    <td><b style="font-size:12px;color:dark;"><?php
                                        if ($previous_duess > 0) {
                                    ...
                                    <td align='right'><b style="font-size:12px;color:dark;"><?php echo $total_amount; ?></td>
                                   
                                    
                                    <td align='left'><b style="font-size:12px;color:dark;"><?php echo $student[$i]->C_MOBILE; ?></td> 
                                </tr>
                                <?php
                                $c++;
                            }
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td></td>
                            <!-- <td></td> -->
                            <td><b style="font-size:12px;color:dark;font-weight: 1000;">TOTAL DUES</b></td>
                            <td align='right'><b style="font-size:12px;color:dark;font-weight: 1000;"><?php echo $grand_tot; ?></b></td>
                            <td></td>
                        </tr>
                    </tfoot>
                </table>
