<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="index.html"><h4><b>Defaulter List Of Student</b></h4></a> <i class=""></i></li>
</ol>
<style>
...
<form id="data_id">
	<div class='row'>
		...
		<div class="col-md-3">
		<br /><center>
		<button class="my-button">DISPLAY</button>
		</center>
		</div>
		<div class="col-md-3">
		<br /><center>
		<a class="btn btn-danger back-button"  href="<?php echo base_url('Report/typeofreports'); ?>">BACK</a></center>
		</center>
		</div>
	</div>
							</br>
