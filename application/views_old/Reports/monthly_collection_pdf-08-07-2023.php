...
<body>
<div>
<p style='float:right; font-size:18px;'>Report Generation Date:<?php echo date('d-m-y'); ?></p><br/><br/>
...
<table width='100%'>
	<tr>
		...
		<th style='float:right;font-size:18px!important;'>Collected By:- <?php echo $counter; ?></th>
	</tr>
</table>
