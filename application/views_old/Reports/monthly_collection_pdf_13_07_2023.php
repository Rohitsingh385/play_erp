...
<body>
<div>
<p style='float:right; font-size:18px;'>Report Generation Date:<?php echo date('d-M-Y'); ?></p><br /><br><br>
	<center><h1 style='font-size:30px; align="center"'><?php echo $School_Name; ?></h1>
			...
			<p style='font-size:22px;'>Monthly Collection Report from <?php echo date('d-M-Y',strtotime($fromdate)); ?> To <?php echo date('d-M-Y',strtotime($todate)); ?></p>
