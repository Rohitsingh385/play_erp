	...
	<div class="container-fluid">
	 ...
	 <div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12">
			...
			<a href="<?php echo base_url('Certificate/re_printpdf/'.$tc_details[0]->adm_no); ?>" target="_blank" class="btn btn-primary" id="generate_pdf"><i class="fa fa-print"></i>&nbsp;GENERATE & DOWNLOAD PDF</a>&nbsp;
			<a class="btn btn-danger" id="print_cancel" href="<?php echo base_url('Certificate/cancel_reprint_tc'); ?>">BACK</a></center>
		</div>
	 </div><br />
	 <div class="row">
		...
		<div class="col-md-4 col-sm-4 col-lg-4">
				  <center><form method="POST" action="<?php echo base_url('Certificate/cancel_financial_year'); ?>">
						<input type="hidden" value="<?php echo $tc_details[0]->adm_no; ?>" id="adm_no" name="adm_no">
						<button class="btn btn-primary" id="cancelled_tc">&nbsp;CANCELLED TC</button>
					</form></center>
			</div>
			<div class="col-md-4 col-sm-4 col-lg-4">
			</div>
