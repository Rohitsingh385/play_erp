<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="index.html"><h4><b>Student Strength<b></h4></a> <i class=""></i></li>
</ol>
<style>
...
<form id="data_id">
	<div class='row'>
		...
		<a class="btn btn-danger back-button" id="" href="<?php echo base_url('Report/typeofreports'); ?>">BACK</a>
