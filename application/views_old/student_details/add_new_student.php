		 ...
		 <div class="row" id="row">
            <div class="col">
                <form method="post" action="<?php echo base_url('Student_details/add_record'); ?>" id="form" onsubmit="return validation()" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-6">
                        <label>Van Stoppage<span id="showbus" class="span">*</span></label>
                      ...
                      <!--<div class="form-group col-md-6">
                        <label>Bus No.</label>
                        <input type="text" class="form-control" id="bs_no" readonly>
                      </div> -->
                    </div>
                    <div class="form-row">
            ...
            <h2 class="text-center" style="color:black;padding-top:10px"><b><i>Sibling Details</i></b></h2>
             ...
             <div class="row">
                      <div class="col-md-12">
                         <center><span id="std_error" class="span"></span></center>
                          <center><a href="#" id="btnbackpar2" class="btn btn-success">BACK</a>&nbsp;<input type="submit" name="submt" value="SAVE" class="btn btn-success"></center><br>
                      </div>
                  </div>        
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
              <center>
                <a href="#" id="btnbackpar3" class="btn btn-success">BACK</a>&nbsp;
