...
<form method='post' id='form_data'>
	...
	<div class="row">
		...
		?>
				<div class="col-md-3 form-group">
					<label><?php echo $feehead1 . ' ( Paid Rs. ' . $paid_amt1 . ' )'; ?></label>
		...
		?>
				<div class="col-md-3 form-group">
					<label><?php echo $feehead2 . ' ( Paid Rs. ' . $paid_amt2 . ' )'; ?></label>
		...
		?>
				<div class="col-md-3 form-group">
					<label><?php echo $feehead3 . ' ( Paid Rs. ' . $paid_amt3 . ' )'; ?></label>
		...
		?>
				<div class="col-md-3 form-group">
					<label><?php echo $feehead4 . ' ( Paid Rs. ' . $paid_amt4 . ' )'; ?></label>
					<input type="text" name="feehead4" onkeypress="return event.charCode>=48 && event.charCode<=57 || event.charCode==46" value="<?php echo $amt_feehead4; ?>" id="feehead4" onchange="amtref()" class="form-control" readonly>
				</div>
			<?php
			} else {
			?>
		...
		?>
				<div class="col-md-3 form-group">
					<label><?php echo $feehead5 . ' ( Paid Rs. ' . $paid_amt5 . ' )'; ?></label>
		...
		?>
				<div class="col-md-3 form-group">
					<label><?php echo $feehead6 . ' ( Paid Rs. ' . $paid_amt6 . ' )'; ?></label>
		...
		?>
				<div class="col-md-3 form-group">
					<label><?php echo $feehead7 . ' ( Paid Rs. ' . $paid_amt7 . ' )'; ?></label>
		...
		?>
				<div class="col-md-3 form-group">
					<label><?php echo $feehead8 . ' ( Paid Rs. ' . $paid_amt8 . ' )'; ?></label>
					<input type="text" name="feehead8" onkeypress="return event.charCode>=48 && event.charCode<=57 || event.charCode==46" value="<?php echo $amt_feehead8; ?>" id="feehead8" onchange="amtref()" class="form-control" readonly>
				</div>
			<?php
			} else {
			?>
		...
		?>
				<div class="col-md-3 form-group">
					<label><?php echo $feehead9 . ' ( Paid Rs. ' . $paid_amt9 . ' )'; ?></label>
		...
		?>
				<div class="col-md-3 form-group">
					<label><?php echo $feehead10 . ' ( Paid Rs. ' . $paid_amt10 . ' )'; ?></label>
		...
		?>
				<div class="col-md-3 form-group">
					<label><?php echo $feehead11 . ' ( Paid Rs. ' . $paid_amt11 . ' )'; ?></label>
		...
		?>
				<div class="col-md-3 form-group">
					<label><?php echo $feehead12 . ' ( Paid Rs. ' . $paid_amt12 . ' )'; ?></label>
		...
		?>
				<div class="col-md-3 form-group">
					<label><?php echo $feehead13 . ' ( Paid Rs. ' . $paid_amt13 . ' )'; ?></label>
					<input type="text" name="feehead13" onkeypress="return event.charCode>=48 && event.charCode<=57 || event.charCode==46" value="<?php echo $amt_feehead13; ?>" id="feehead13" onchange="amtref()" class="form-control" readonly>
				</div>
			<?php
			} else {
			?>
		...
		?>
				<div class="col-md-3 form-group">
					<label><?php echo $feehead14 . ' ( Paid Rs. ' . $paid_amt14 . ' )'; ?></label>
		...
		?>
				<div class="col-md-3 form-group">
					<label><?php echo $feehead15 . ' ( Paid Rs. ' . $paid_amt15 . ' )'; ?></label>
		...
		?>
				<div class="col-md-3 form-group">
					<label><?php echo $feehead16 . ' ( Paid Rs. ' . $paid_amt16 . ' )'; ?></label>
					<input type="text" name="feehead16" onkeypress="return event.charCode>=48 && event.charCode<=57 || event.charCode==46" value="<?php echo $amt_feehead16; ?>" id="feehead16" onchange="amtref()" class="form-control" readonly>
				</div>
			<?php
			} else {
			?>
		...
		?>
				<div class="col-md-3 form-group">
					<label><?php echo $feehead17 . ' ( Paid Rs. ' . $paid_amt17 . ' )'; ?></label>
		...
		?>
				<div class="col-md-3 form-group">
					<label><?php echo $feehead18 . ' ( Paid Rs. ' . $paid_amt18 . ' )'; ?></label>
					<input type="text" name="feehead18" onkeypress="return event.charCode>=48 && event.charCode<=57 || event.charCode==46" value="<?php echo $amt_feehead18; ?>" id="feehead18" onchange="amtref()" class="form-control" readonly>
				</div>
			<?php
			} else {
			?>
		...
		?>
				<div class="col-md-3 form-group">
					<label><?php echo $feehead19 . ' ( Paid Rs. ' . $paid_amt19 . ' )'; ?></label>
		...
		?>
				<div class="col-md-3 form-group">
					<label><?php echo $feehead20 . ' ( Paid Rs. ' . $paid_amt20 . ' )'; ?></label>
		...
		?>
				<div class="col-md-3 form-group">
					<label><?php echo $feehead21 . ' ( Paid Rs. ' . $paid_amt21 . ' )'; ?></label>
		...
		?>
				<div class="col-md-3 form-group">
					<label><?php echo $feehead22 . ' ( Paid Rs. ' . $paid_amt22 . ' )'; ?></label>
		...
		?>
				<div class="col-md-3 form-group">
					<label><?php echo $feehead23 . ' ( Paid Rs. ' . $paid_amt23 . ' )'; ?></label>
		...
		?>
				<div class="col-md-3 form-group">
					<label><?php echo $feehead24 . ' ( Paid Rs. ' . $paid_amt24 . ' )'; ?></label>
		...
		?>
				<div class="col-md-3 form-group">
					<label><?php echo $feehead25 . ' ( Paid Rs. ' . $paid_amt25 . ' )'; ?></label>
	...
	<div class="row">
		<div class="col-md-3">
			...
			<input type="text" style="text-align: right;" name="rsa" id="rsa" readonly value="<?php echo $recover; ?>" class="form-control">
		</div>
		...
		<?php if ($month == 12) { ?>
			<div class="col-md-3">
				...
				<input type="text" disabled style="text-align: right;" name="paidamount" id="paidamount" onchange="checkamt()" onkeyup="calculateShortAmount()" value="<?php echo $gross_amount; ?>" class="form-control">
			</div>
		<?php } else { ?>

			<div class="col-md-3">
				<label>Paid Amount</label>
				<input type="text" style="text-align: right;" name="paidamount" id="paidamount" onchange="checkamt()" onkeyup="calculateShortAmount()" value="<?php echo $gross_amount; ?>" class="form-control" onkeydown="return disableEnterKey(event)">
			</div>
		<?php } ?>
				...
				<div class="modal-body">
					...
					<div class="row" style="display: none;" id="transation_show">
						<div class="col-md-12 form-group">
							...
							<input type="text" minlength="4" onkeypress='return event.charCode >= 48 && event.charCode<= 57 || event.charCode >= 65 && event.charCode<= 90 || event.charCode >= 95 && event.charCode<= 122 || event.charCode == 32' placeholder="Enter transation id" autocomplete="off" name="transation_name" id="transation_name" class="form-control">
						</div>
					</div>
...
<script type="text/javascript">
	...
	let paidamt = parseFloat(document.getElementById('paidamount').value);
	...
	function checkamt() {
		...
		if (paidAmount > grossAmount) {
			...
			document.getElementById('shortamount').value = '0';
		}
	...
	function calculateShortAmount() {
		...
		var shortAmount = grossAmount - paidAmount;
	...
	function amtref() {
		...
		var pndpay = parseFloat(document.getElementById('rsa').value);


		var sum = (feehead1 + feehead2 + feehead3 + feehead4 + feehead5 + feehead6 + feehead7 + feehead8 + feehead9 + feehead10 + feehead11 + feehead12 + feehead13 + feehead14 + feehead15 + feehead16 + feehead17 + feehead18 + feehead19 + feehead20 + feehead21 + feehead22 + feehead23 + feehead24 + feehead25 + pndpay);
