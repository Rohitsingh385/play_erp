...
<body>
	<div id="body">
		<div id="box1">
			<center><img src="<?php echo base_url($school_logo); ?>" height="73px" width="78px;"></center>
			<div class="table_heading">
				<center><span class="heading"><?php echo $school_name; ?></span><BR></center>
				<center><span class="address"><?php echo $school_add; ?></span><br></center>
				<center><span class="telaff">Tel No.: <?php echo $school_phone; ?> ,</span><span class="telaff"> Affln No.: <?php echo $school_aff; ?></span><br></center>
				<center><span class="webemail">Website: <?php echo $school_web; ?></span><!-- <span class="webemail"> Email: <?php //echo $school_email; 
																																?></span> --><br></center>
				<center><span class="feecopy">FEE-RECEIPT(OFFICE COPY)</span></center>
			</div>
			...
			<?php if ($SHORT_AMOUNT > 0) { ?>
				<tr class="tr_main">
					<td colspan="2" class="td_main" style="text-align:right; padding-right:5px;">Pending Amount (&#8377;)</td>
	...
	<div style="position: relative; margin-top: 50%; margin-left: 45%;">
		<button class="btn btn-primary" id="printing_button" onclick="printl()">PRINT</button>&nbsp;<a class="btn btn-danger" id="" href="<?php echo base_url('Monthly_collection/month_collection') ?>">BACK</a>
	</div>
	<br>
	<br>
	<br>
